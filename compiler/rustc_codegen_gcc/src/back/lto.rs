...
use crate::{GccCodegenBackend, GccContext, LtoMode, SyncContext, new_context};
...
fn fat_lto(
    ...
    let mut module: ModuleCodegen<GccContext> = ModuleCodegen::new_regular(
        "<lto module>".to_string(),
        GccContext {
