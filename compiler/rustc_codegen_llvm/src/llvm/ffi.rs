...
extern "C" {
    ...
    pub(crate) fn LLVMGetTypeKind(Ty: &Type) -> RawEnum<TypeKind>;
    ...
    pub(crate) fn LLVMSetTailCallKind(CallInst: &Value, kind: TailCallKind);
    pub(crate) fn LLVMSetExternallyInitialized(GlobalVar: &Value, IsExtInit: Bool);
...
extern "C" {
    ...
    pub(crate) fn LLVMRustLLVMHasZlibCompression() -> bool;
    pub(crate) fn LLVMRustLLVMHasZstdCompression() -> bool;
